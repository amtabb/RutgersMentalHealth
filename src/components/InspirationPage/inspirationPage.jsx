...
function Poster({postAnomyously}) {
  ...
  /*
    const postOnChage = useCallback((event) => {
        setInspirationPost(event.target.value);
    }, []);
    

    const submitpost = useCallback(() => {
        Axios.post(url+'insertinspirationposts', {
            inspirationpost
            });
    }, [inspirationpost]);

    <input type="text" name="txtinspirationpost" value={inspirationpost} onChange={postOnChage} width = "300px" height = "200px" ></input>
    */
    ...
    return (
        <div className="overlap-group4">
          <div className="overlap-group-2">
            ...
            <input type="text" name="txtinspirationpost" onChange={(e)=> {setInspirationPost(e.target.value)}} style={{ height: '100%', width: '100%',textAlignVertical: "top"}}></input>
            </div>
